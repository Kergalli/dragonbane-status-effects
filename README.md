...
[![Module Version](https://img.shields.io/badge/Version-1.0.8-brightgreen)](https://github.com/Kergalli/dragonbane-status-effects/releases)
...
A comprehensive status effects module for the **Dragonbane** system in **Foundry Virtual Tabletop V12**. This module provides 41 carefully curated status effects with visual editors, enhanced Token HUD styling, and seamless Dragonbane system integration.
...
3. Paste this manifest URL: `https://github.com/Kergalli/dragonbane-status-effects/releases/download/v1.0.8/module.json`
4. Click **Install**
